      ...
      <div>
        ...
        <div className="aboutdisplay">
          <span className="aboutwords">
            ...
            <p>
              - The goal of this application is to make personal financing fun
              and easy. Plan for success, execute accordingly.
            </p>
            <br />
            <p>
              <strong> - WHO : </strong>This application is for people with
              consistant expenses who are able to save a portion of their
              paycheck to retirement. If that sounds like you, then this app is
              for you!
            </p>
            <br />
            <p>
              <strong> - HOW the App Works : </strong> The application will help
              you build an income statement. A breakdown of your expenses will
              be available via email. You will then be able to explore the
              results of different savings rates and choose what percentage is
              right for you.
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              financially capable is a win. This application should make you
              aware of your spending habits which is a great start towards
